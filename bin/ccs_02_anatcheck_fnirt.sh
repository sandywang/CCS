...
check_anatfnirt_list=${dir}/scripts/check_anatfnirt.list
## Start scripts
...
do
	...
	then
		...
		title=${subject}.ccs.anat.fnirt.reg
       	convert -font helvetica -fill white -pointsize 36 -draw "text 30,50 '$title'" vcheck/fnirt_highres2standard_ref.png vcheck/fnirt_highres2standard_ref.png
	else
	...
	echo ${subject} >> ${check_anatfnirt_list}
done
