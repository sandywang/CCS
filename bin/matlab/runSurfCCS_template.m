clear all; clc ;
ana_dir ='/Volumes/RAID/projects/indi/NKI-RS';
ccs_dir = [ana_dir '/scripts/ccs_beta'];
ccs_matlab = [ccs_dir '/matlab'];
subs126_list = [ana_dir '/scripts/subjects_final126.list'];
...
gmask126 = ccs_07_grp_SurfMask( ana_dir, subs126_list, 'func', grpmask_dir, ...
