function err = ccs_06_singlesubject2dALFF( ana_dir, sub_list, rest_name, ...
    tr, func_dir_name, fs_home, fsaverage)
%LFCD_06_SINGLESUBJECTALFF_SURF Computing the ALFF/FALFF on the surface.
...
for k=1:nsubs
    ...
    for fwhm = [0]
        ...
        %ALFF
        surfMASKhdr_lh.vol = cALFF_lh; fout = [alff_dir '/lh.alff.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        ...
        err = save_nifti(surfMASKhdr_lh, fout);
        %ALFF slow4
        surfMASKhdr_lh.vol = cALFFs4_lh; fout = [alff_dir '/lh.alff.slow4.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        err = save_nifti(surfMASKhdr_lh, fout);
        ...
        err = save_nifti(surfMASKhdr_lh, fout);
        %FALFF
        surfMASKhdr_lh.vol = cFALFF_lh; fout = [alff_dir '/lh.falff.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        err = save_nifti(surfMASKhdr_lh, fout);
        ...
        err = save_nifti(surfMASKhdr_lh, fout);
        %FALFF slow4
        surfMASKhdr_lh.vol = cFALFFs4_lh; fout = [alff_dir '/lh.falff.slow4.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        err = save_nifti(surfMASKhdr_lh, fout);
    ...
    for fwhm = [0]
        ...
        %ALFF
        surfMASKhdr_rh.vol = cALFF_rh; fout = [alff_dir '/rh.alff.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        ...
        err = save_nifti(surfMASKhdr_rh, fout);
        %ALFF slow4
        surfMASKhdr_rh.vol = cALFFs4_rh; fout = [alff_dir '/rh.alff.slow4.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        err = save_nifti(surfMASKhdr_rh, fout);
        ...
        err = save_nifti(surfMASKhdr_rh, fout);
        %FALFF
        surfMASKhdr_rh.vol = cFALFF_rh; fout = [alff_dir '/rh.falff.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        err = save_nifti(surfMASKhdr_rh, fout);
        ...
        err = save_nifti(surfMASKhdr_rh, fout);
        %FALFF slow4
        surfMASKhdr_rh.vol = cFALFFs4_rh; fout = [alff_dir '/rh.falff.slow4.sm' num2str(fwhm) '.' fsaverage '.nii.gz'];
        err = save_nifti(surfMASKhdr_rh, fout);
