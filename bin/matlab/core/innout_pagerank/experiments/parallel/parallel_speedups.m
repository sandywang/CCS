...
saveas(gcf,['parallel-speedup-ratio.fig'],'fig');
print(gcf,['parallel-speedup-ratio.eps'],'-depsc2','-cmyk');        
...
set(gca,'YTick',[4 5 6]); set(gca,'XTick',8);
saveas(gcf,['parallel-speedup-ratio-fancy.fig'],'fig');
print(gcf,['parallel-speedup-ratio-fancy.eps'],'-depsc2','-cmyk');        
