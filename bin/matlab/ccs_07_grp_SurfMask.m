function [gmask] = ccs_07_grp_SurfMask( ana_dir, sub_list, func_dir_name, grpmask_dir, prefix_mask, fs_home, fsaverage )
...
if nargin < 7
    disp('Usage: ccs_07_grp_SurfMask( ana_dir, sub_list, func_dir_name, grpmask_dir, prefix_mask, fs_home, fsaverage )')
    exit
end
