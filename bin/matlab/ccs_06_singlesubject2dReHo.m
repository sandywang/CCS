function err = ccs_06_singlesubject2dReHo( ana_dir, sub_list, rest_name, func_dir_name, fsaverage, fs_vertex_adj, neighbor_type)
%LFCD_06_SINGLESUBJECTREHO_SURF Computing the ReHo on the surface.
